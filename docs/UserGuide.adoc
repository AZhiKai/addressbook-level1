...
Phone number, email and date of birth can be in any order but the name MUST come first.
====

Examples:

* `add John Doe p/98765432 e/johnd@gmail.com dob/05041996`
...
[NOTE]
====
The search is NOT case sensitive, the order of the keywords does not matter, only the name is
searched,
...
Sort all entries from the address book in ascending order (default). +
Format: `sort`
